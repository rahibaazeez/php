...
$id=$_GET['id'];
echo var_dump($id);
$sql=mysqli_query($conn,"SELECT * FROM student_reg WHERE id='$id'");
...
if(isset($_POST['submit'])){
    ...
    $sql1=mysqli_query($conn,"UPDATE student_reg SET name='$name',email='$email',phone='$phone',photo='$image' WHERE id='$id'");
    if($sql1)
    {
        echo '<script> alert("updated sucessfully");window.location.href="reg_display.php";</script>';
    }
    else{
